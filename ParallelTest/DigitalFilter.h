...
public:
	 ...
	 *             @f$ \tau_c = \frac{1}{2 pi f_c}@f$  where @f$ f_c @f$ is the cutoff frequency
	 */
    LowPassFilter2(double dt, double tau_c) : yc{
...
{
public:
    HighPassFilter3(double sampleTime, double omega_c) : xc{
                                                             8,
                                                             -24,
                                                             24,
                                                             -8},
...
{
public:
    LowPassFilter3(long double sampleTime, long double omega_c) : yc{
                                                                      1,
...
{
public:
    LowPassFilter3DiffApprox(double sampleTime, double omega_c) : xc{
